...
function SignUp() {
  ...
  // Placeholder: here you would call your API to create a student account.
  // For now we'll just log and navigate to sign in.
  const payload = { firstName, lastName, email };
  console.log('Registering new student:', payload);
