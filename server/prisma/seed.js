...
async function main() {
  ...
  const students = [
    ...
    { email: 'mike@univibe.edu', password: 'password123', firstName: 'Mike', lastName: 'Chen', role: 'MODERATOR' },
    ...
    { email: 'lisa@univibe.edu', password: 'password123', firstName: 'Lisa', lastName: 'Wang', role: 'MODERATOR' },
    ...
    { email: 'james@univibe.edu', password: 'password123', firstName: 'James', lastName: 'Wilson', role: 'MODERATOR' },
